# JT/T 809-2019 下级平台模拟器

## 📖 简介

JT/T 809-2019 下级平台模拟器用于测试上级平台服务器的功能，完整实现了标准的 JT/T 809-2019 协议主链路和从链路交互流程。
...
- ✅ 主链路心跳保活（每30秒）
- ✅ 从链路心跳响应
- ✅ 时效口令上报（JT/T 1078-2016，登录后主动上报）
- ✅ 时效口令请求应答（JT/T 1078-2016，被动响应）
- ✅ 车辆注册信息上报
- ✅ GPS实时定位数据上报（可配置间隔）
- ✅ 车辆定位信息交换请求应答（订阅/取消订阅GPS）
- ✅ 实时视频请求应答（JT/T 1078-2016）
...
- [JT/T 809-2019 协议库](../../pkg/jtt809)

---

## 🔧 协议实现

本模拟器实现了以下 JT/T 809-2019 标准消息：
